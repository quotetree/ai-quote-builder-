-- EMERGENCY: Restore the working trigger from before
-- This will get signups working again immediately

-- Drop the broken trigger
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP FUNCTION IF EXISTS public.handle_new_user();

-- Restore the ORIGINAL working trigger (from your backup)
-- This is the version that was working before you applied any fixes
...
COMMENT ON FUNCTION public.handle_new_user() IS 'Automatically creates profile, organization, and trial subscription when user signs up';

-- Verify it was created
SELECT 
    'Trigger restored successfully!' as status,
